    ...
    return (
      <div className="App">
        <header className="App-header">
          ...
          <h1 className="App-title">Climate App 2.1</h1>
        </header>
        <main role="main">
            ...
            <div className="main-container">
              <div className="setting-container">
                <SingleSettingController>
                  <SliderSetting settingName="Solar Radiation" maxSettingValue={100} step={0.1} default={50} setting={this.state.stellarRadiation} handler={this.changeStellarRadiation} marks={radiationMarks} units={"S₀"}/>
                </SingleSettingController>
                <SingleSettingController>
                  <LayerContainer settingName="Atmosphere" layers={this.state.layers} addNewDefaultLayer={this.addNewDefaultLayer} alphaHandler={this.changeAlpha}>
                    <AtmLayer removeLayer={this.removeLayer} />
                  </LayerContainer>
                </SingleSettingController>
                <SingleSettingController position = 'last'>
                  <SliderSetting settingName="Planetary Refletivity" maxSettingValue={0.99} step={0.01} default={this.state.planetaryAlbedo} setting={this.state.planetaryAlbedo} handler={this.changeAlbedo} marks={defaultMarks}/>
                </SingleSettingController>
